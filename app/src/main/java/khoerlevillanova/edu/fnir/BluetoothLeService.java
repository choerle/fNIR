...
import static khoerlevillanova.edu.fnir.DeviceControlActivity.getDecimal;
...
public class BluetoothLeService extends Service {
    ...
    //Broadcast for recieving data
    private void broadcastUpdate(final String action,
                                 final BluetoothGattCharacteristic characteristic) {
        final Intent intent = new Intent(action);

        //Dont read from data collection service
        if(characteristic == mBluetoothGatt.getService(UUID_SERVICE).getCharacteristic(UUID_CHARACTERISTIC))
            return;
    ...
    //Reads voltages from data collection service
